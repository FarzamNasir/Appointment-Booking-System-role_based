...
// Example: get admin token for protected API requests
...
const PatientsPage = () => {
  ...
  // Use adminToken in fetch requests as needed, e.g.:
  // fetch('/api/protected', { headers: { Authorization: `Bearer ${adminToken}` } })
                      ...
                      <td className="py-4 px-4">
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            variant="ghost"
                            className="text-slate-400 hover:text-medical-accent hover:bg-glass-light"
                          >
