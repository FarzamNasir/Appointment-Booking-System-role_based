...
import { Calendar, MessageCircle, UserCheck, Clock, Users, Mic } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold text-white">Medical Flow Dashboard</h1>
      </div>
      ...
      <div className="card-glass mb-12 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Experience the future of healthcare with our AI-powered platform that connects you with the right doctors, 
            manages your appointments, and provides instant medical guidance.
          </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-slate-400">Browse available specialists</div>
            </div>
          </Button>
